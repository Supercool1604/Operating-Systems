...
void priorityScheduling(vector<pair<ll,ll>> proc_arr ,ll proc_prio[] ,ll proc_burs[] , int n , ll turn_around_time[] , ll response_time[]) 
{ 
ll t =0 ;
...
{ 
 ...
 cout<<"Enter Quantum value : " ;
    ...
    // }
    priorityScheduling(proc_arr , proc_prio , proc_burs, n, turn_around_time ,response_time); 
    return 0; 
} 